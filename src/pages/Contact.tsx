        ...
        <div className=' w-full  lg:w-[29rem]  px-2 lg:py-5 mt-10'>
                  ...
                  <div className='s mt-6 m-auto w-[100%] lg:w-[74%] '>
                        ...
                        <div className=" bg-[#123]
                            ...
                            <TfiPinterest className=' cursor-pointer text-[28px] md:text-[34px] md:text-[] text-[#4cdfb5]' />
                            <FiLinkedin className=' cursor-pointer text-[28px] md:text-[34px]  text-[#4cdfb5]' />
                       </div>
                 </div>
          </div>
          <form className=" mt-6 flex flex-col px-5 md:px-0">
                            <div className="border- relative  borde-2  py-6">
                          ...
                          h-[4rem] w-[18rem] sm:w-[22rem] md:w-[26rem]  px-4 rounded-[13px]
                          ...
                          "/>
                            ...
                            <div className=" relative  borde-2 py-6">
                                    ...
                                    h-[4rem] w-[18rem] sm:w-[22rem] md:w-[26rem]   px-4 rounded-[13px] text-[#123]
                                    placeholder:text-[#123] font-1  text-[16px]
                                    border-2 border-[#123]
                                    outline-none bg-[#a1f3dc] 
                                    "/>
                            ...
                            <label htmlFor="name"
                                    ...
                                    >Messge</label>
                                    <textarea className="
                                     h-[14rem] w-[18rem] sm:w-[22rem] md:w-[26rem]   px-4 pt-10 rounded-[13px]
